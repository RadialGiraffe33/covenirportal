    ...
    <footer className="bg-covenir-dark text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Brand */}
          <div>
            <CovenirLogo theme="dark" size="sm" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              ...
              <li>
                <a href="tel:+15084715031" className="hover:text-white transition-colors">(508) 471-5031</a>
              </li>
              <li>
                <a href="mailto:info@covenirbpo.com" className="hover:text-white transition-colors">info@covenirbpo.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="https://www.covenirbpo.com" target="_blank" rel="noopener noreferrer"
                   className="text-white/70 hover:text-white transition-colors">CovenirBPO.com</a>
              </li>
              <li>
                <a href="https://www.covenirenterprise.com" target="_blank" rel="noopener noreferrer"
                   className="text-white/70 hover:text-white transition-colors">Covenir Enterprise</a>
              </li>
              <li>
                <a href="https://www.covenirbpo.com/privacy-policy" target="_blank" rel="noopener noreferrer"
                   className="text-white/70 hover:text-white transition-colors">Privacy Policy</a>
              </li>
            </ul>
            ...
            <div className="flex gap-3 mt-6">
              <a href="https://www.linkedin.com/company/covenirbpo" target="_blank" rel="noopener noreferrer"
                 aria-label="LinkedIn"
                 className="w-8 h-8 rounded-lg bg-white/10 hover:bg-covenir-navy flex items-center justify-center transition-colors">
